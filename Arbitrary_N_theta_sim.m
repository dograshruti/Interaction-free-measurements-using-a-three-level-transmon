...
GAMMA10phi = 0.6*0.2967e6;% Pure dephasing rate for 0-1 transition
GAMMA21 = 0.75*1.536e6; % 1.536e6; % Relaxation rate for 1-2 transition
GAMMA21phi = 0.9*1.6*0.8*1.585e6; % Pure dephasing rate for 1-2 transition
...
ideal_case=0;
  ...
  v02=v01+v12;
  T=0.075*(1-ideal_case)+0.001*ideal_case;%0.098;%0.098;
